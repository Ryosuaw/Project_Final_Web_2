...
<head>
    ...
    <style>
        * {
        ...
        .opp-org svg { width: 14px; height: 14px; }
        ...
        .partner-verified { color: var(--primary); }
        .partner-verified svg { width: 16px; height: 16px; }
        ...
        .partner-location svg { width: 12px; height: 12px; }
        ...
        .sidebar-right { display: flex; flex-direction: column; gap: var(--space-5); }
        ...
        .profile-card-role { font-size: 13px; color: var(--gray-600); font-weight: 500; }
        ...
        .profile-card-verified svg { width: 14px; height: 14px; }

        .profile-progress { margin-bottom: var(--space-5); }
        ...
        .profile-progress-label { font-size: 13px; font-weight: 600; color: var(--gray-800); }
        ...
        .profile-progress-hint { font-size: 12px; color: var(--gray-500); line-height: 1.4; }

        .profile-skills { margin-bottom: var(--space-5); }
        ...
        .profile-skill-tags { display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: var(--space-3); }
        ...
        .activity-title svg { width: 20px; height: 20px; color: var(--purple); }
        ...
        .activity-icon-purple { background: #f3f0ff; color: #7c3aed; }
        .activity-icon-orange { background: var(--warning-bg); color: var(--warning); }
        .activity-icon-green { background: var(--success-bg); color: var(--success); }

        .activity-text { font-size: 13px; color: var(--gray-800); line-height: 1.4; font-weight: 500; }
        .activity-time { font-size: 12px; color: var(--gray-500); margin-top: 2px; font-weight: 500; }
        ...
        <aside class="sidebar">
            <div class="sidebar-section">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <a href="<?php echo e(url('/peluang/beasiswa')); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(url('/peluang/kompetisi')); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(url('/peluang/seminar-webinar')); ?>">
                    ...
                    <li>
                       <a  href="<?php echo e(route('study-club.index')); ?>">
            ...
            <div class="sidebar-promo">
                ...
                <a href="<?php echo e(route('study-club.index')); ?>" class="sidebar-promo-btn" style="text-decoration: none;">Explore Groups →</a>
            </div>
...
<?php endif; ?>
            ...
            <div class="page-header">
                <div class="page-header-content">
                    ...
                    <p>Ada <?php echo e($partnerRequestCount); ?> partner request baru & <?php echo e($opportunities->count()); ?> peluang yang cocok dengan skill kamu hari ini.</p>
                </div>
                <div class="page-actions">
                    <a href="<?php echo e(url('/skill-exchange')); ?>" class="btn btn-secondary">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        Cari Partner
                    </a>
                    <a href="<?php echo e(url('/peluang/beasiswa')); ?>" class="btn btn-primary">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 14l9-5-9-5-9 5 9 5z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"/></svg>
                        Lihat Peluang
                    </a>
                </div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <div class="stat-value"><?php echo e($skillAktifCount); ?></div>
                        <div class="stat-label">Skill Aktif</div>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <div class="stat-value"><?php echo e($partnerRequestCount); ?></div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <div class="stat-value"><?php echo e($savedOpportunityCount); ?></div>
                        <div class="stat-label">Peluang Disimpan</div>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <div class="stat-value"><?php echo e($matchRate); ?>%</div>
                    ...
                    <div class="section-card">
                        <div class="section-header">
                            <h2 class="section-title">
                                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="color: var(--warning);"><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                                Peluang Terbaru Untukmu
                            </h2>
                           <a href="<?php echo e(url('/peluang/beasiswa')); ?>" class="section-link">Lihat Semua →</a>
                        </div>
                                ...
                                <div class="opp-card">
                                    ...
                                    <div class="opp-tags">
                                        <?php $__currentLoopData = $opp->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="opp-tag-sm"><?php echo e($tag); ?></span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <div class="opp-meta">
                                        <div class="opp-meta-item">
                                            <label>Deadline</label>
                                            <span class="deadline"><?php echo e(\Carbon\Carbon::parse($opp->deadline)->translatedFormat('d M Y')); ?></span>
                                        </div>
                                        <div class="opp-meta-item">
                                            <label>Benefit</label>
...
?>
<a href="<?php echo e(url('/peluang/' . $typeUrlMap[$opp->type])); ?>" class="btn btn-primary" style="width: 100%; justify-content: center; text-decoration: none;">Lihat Detail</a> 
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="empty-state">Belum ada peluang tersedia.</div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="section-card">
                        <div class="section-header">
                            ...
                            <a href="<?php echo e(url('/skill-exchange')); ?>" class="section-link">Skill Exchange →</a>
                        </div> 

                        <div class="partner-grid">
                            <?php $__empty_1 = true; $__currentLoopData = $partnerRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="partner-card">
                                    <div class="partner-header">
                                        <div class="partner-avatar">
                                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($req->sender_name)); ?>&background=random" alt="<?php echo e($req->sender_name); ?>">
                                            <span class="partner-online"></span>
                                        </div>
                                        <div class="partner-info">
                                            <div class="partner-name">
                                                <?php echo e($req->sender_name); ?>

                                                <span class="partner-verified">
                                            ...
                                            <div class="partner-role"><?php echo e($req->sender_major); ?></div>
                                            <div class="partner-location">
                                                ...
                                                <?php echo e($req->sender_university); ?>

                                            </div>
                                        </div>
                                        <div class="partner-match">
                                            <div class="partner-match-value"><?php echo e($req->match_percentage); ?>%</div>
                                            <div class="partner-match-label">Match</div>
                                        </div>
                                    </div>

                                    <div class="partner-quote">"<?php echo e($req->message); ?>"</div>

                                    <div class="partner-skills-section">
                                        <div class="partner-skills-label teach">
                                            <svg fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>
                                            BISA MENGAJARI
                                        </div>
                                        <div class="partner-skill-tags">
                                            <?php $__currentLoopData = $req->skills_teach; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="partner-skill-tag teach"><?php echo e($skill); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>

                                    <div class="partner-skills-section">
                                        <div class="partner-skills-label learn">
                                            <svg fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 14l-7 7m0 0l-7-7m7 7V3"/></svg>
                                            INGIN BELAJAR
                                        </div>
                                        <div class="partner-skill-tags">
                                            <?php $__currentLoopData = $req->skills_learn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="partner-skill-tag learn"><?php echo e($skill); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>

                                   <div class="partner-actions">
    <form method="POST" action="<?php echo e(url('/skill-exchange/requests/' . $req->id . '/accept')); ?>" style="flex: 1;">
        <?php echo csrf_field(); ?>
    ...
    <form method="POST" action="<?php echo e(url('/skill-exchange/requests/' . $req->id . '/reject')); ?>" style="flex: 1;">
        <?php echo csrf_field(); ?>
        <button type="submit" class="btn btn-ghost" style="width: 100%;">
            ...
            Tolak
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="empty-state">Belum ada partner request.</div>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="profile-card">
                        <div class="profile-card-header">
                            ...
                            <div>
                                ...
                                <div class="profile-card-role"><?php echo e($user->major); ?> — <?php echo e($user->university); ?></div>
                        ...
                        <div class="profile-progress">
                            <div class="profile-progress-header">
                                <span class="profile-progress-label">Kelengkapan Profil</span>
                                <span class="profile-progress-value"><?php echo e($user->profile_completion); ?>%</span>
                            </div>
                            <div class="profile-progress-bar">
                                <div class="profile-progress-fill" style="width: <?php echo e($user->profile_completion); ?>%;"></div>
                            </div>
                            <p class="profile-progress-hint">Tambahkan skill lagi untuk match lebih banyak partner.</p>
                        </div>

                        <div class="profile-skills">
                            <div class="profile-skills-title">SKILL SAYA</div>
                            <div class="profile-skill-tags">
                                <?php $__empty_1 = true; $__currentLoopData = $mySkills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <span class="profile-skill-tag"><?php echo e($skill); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <span class="empty-state">Belum ada skill ditambahkan.</span>
                                <?php endif; ?>
                                <a href="<?php echo e(url('/skills/create')); ?>" class="profile-skill-add" style="text-decoration: none; display: inline-block;">+ Tambah</a>
                            </div>
                        </div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li class="activity-item">
                                    ...
                                    <div>
                                        ...
                                        <div class="activity-time"><?php echo e(\Carbon\Carbon::parse($activity->created_at)->diffForHumans()); ?></div>
                                    </div>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php /**PATH D:\laragon\www\Project_Final_Web_2\backend\resources\views/dashboard.blade.php ENDPATH**/ ?>