        ...
        <div class="navbar-actions">
            ...
            <div class="navbar-user">
                <div class="navbar-user-avatar">
                    <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=0066ff&color=fff" alt="{{ $user->name }}">
                </div>
                <div class="navbar-user-info">
                    <div class="navbar-user-name">{{ $user->name }}</div>
                    <div class="navbar-user-role">{{ $user->major ?? '-' }}</div>
                </div>
        ...
        <aside class="sidebar">
            <div class="sidebar-section">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <a href="{{ url('/peluang/seminar-webinar') }}">
            ...
            <div class="sidebar-promo">
                ...
                <a href="{{ route('study-club.index') }}" class="sidebar-promo-btn" style="text-decoration: none;">Explore Groups →</a>
            </div>
...
@endif
            ...
            <div class="page-header">
                <div class="page-header-content">
                    ...
                    <p>Ada {{ $partnerRequestCount }} partner request baru & {{ $opportunities->count() }} peluang yang cocok dengan skill kamu hari ini.</p>
                </div>
                <div class="page-actions">
                    <a href="{{ url('/skill-exchange') }}" class="btn btn-secondary">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        Cari Partner
                    </a>
                    <a href="{{ url('/peluang/beasiswa') }}" class="btn btn-primary">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 14l9-5-9-5-9 5 9 5z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"/></svg>
                        Lihat Peluang
                    </a>
                </div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <div class="stat-value">{{ $skillAktifCount }}</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <div class="stat-value">{{ $partnerRequestCount }}</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <div class="stat-value">{{ $savedOpportunityCount }}</div>
                ...
                <div class="content-main">
                    ...
                    <div class="section-card">
                        <div class="section-header">
                           ...
                           <a href="{{ url('/peluang/beasiswa') }}" class="section-link">Lihat Semua →</a>
                        </div>
                                ...
                                <div class="opp-card">
                                    ...
                                    <div class="opp-tags">
                                        @foreach ($opp->tags as $tag)
                                            <span class="opp-tag-sm">{{ $tag }}</span>
                                        @endforeach
                                    </div>
                                    <div class="opp-meta">
                                        <div class="opp-meta-item">
                                            <label>Deadline</label>
                                            <span class="deadline">{{ \Carbon\Carbon::parse($opp->deadline)->translatedFormat('d M Y') }}</span>
                                        </div>
                                        <div class="opp-meta-item">
                                            <label>Benefit</label>
...
@endphp
<a href="{{ url('/peluang/' . $typeUrlMap[$opp->type]) }}" class="btn btn-primary" style="width: 100%; justify-content: center; text-decoration: none;">Lihat Detail</a> 
                                </div>
                            @empty
                    ...
                    <div class="section-card">
                        <div class="section-header">
                            ...
                            <a href="{{ url('/skill-exchange') }}" class="section-link">Skill Exchange →</a>
                        </div> 

                        <div class="partner-grid">
                            @forelse ($partnerRequests as $req)
                                <div class="partner-card">
                                    <div class="partner-header">
                                        <div class="partner-avatar">
                                            <img src="https://ui-avatars.com/api/?name={{ urlencode($req->sender_name) }}&background=random" alt="{{ $req->sender_name }}">
                                        ...
                                        <div class="partner-info">
                                            ...
                                            <div class="partner-role">{{ $req->sender_major }}</div>
                                            <div class="partner-location">
                                                ...
                                                {{ $req->sender_university }}
                                            </div>
                                        </div>
                                        <div class="partner-match">
                                            <div class="partner-match-value">{{ $req->match_percentage }}%</div>
                                            <div class="partner-match-label">Match</div>
                                        </div>
                                    </div>

                                    <div class="partner-quote">"{{ $req->message }}"</div>
                                    ...
                                    <div class="partner-skills-section">
                                        ...
                                        <div class="partner-skill-tags">
                                            @foreach ($req->skills_teach as $skill)
                                                <span class="partner-skill-tag teach">{{ $skill }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <div class="partner-skills-section">
                                        ...
                                        <div class="partner-skill-tags">
                                            @foreach ($req->skills_learn as $skill)
                                                <span class="partner-skill-tag learn">{{ $skill }}</span>
                                            @endforeach
                                        </div>
                                    </div>

                                   <div class="partner-actions">
    <form method="POST" action="{{ url('/skill-exchange/requests/' . $req->id . '/accept') }}" style="flex: 1;">
        @csrf
    ...
    <form method="POST" action="{{ url('/skill-exchange/requests/' . $req->id . '/reject') }}" style="flex: 1;">
        @csrf
                    ...
                    <div class="profile-card">
                        <div class="profile-card-header">
                            ...
                            <div>
                                ...
                                <div class="profile-card-role">{{ $user->major }} — {{ $user->university }}</div>
                                @if ($user->is_verified)
                        ...
                        <div class="profile-progress">
                            <div class="profile-progress-header">
                                ...
                                <span class="profile-progress-value">{{ $user->profile_completion }}%</span>
                            </div>
                            <div class="profile-progress-bar">
                                <div class="profile-progress-fill" style="width: {{ $user->profile_completion }}%;"></div>
                            </div>
                        ...
                        <div class="profile-skills">
                            ...
                            <div class="profile-skill-tags">
                                @forelse ($mySkills as $skill)
                                    <span class="profile-skill-tag">{{ $skill }}</span>
                                @empty
                                    <span class="empty-state">Belum ada skill ditambahkan.</span>
                                @endforelse
                                <a href="{{ url('/skills/create') }}" class="profile-skill-add" style="text-decoration: none; display: inline-block;">+ Tambah</a>
                            </div>
                        </div>
