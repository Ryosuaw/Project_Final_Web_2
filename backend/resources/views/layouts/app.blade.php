...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-actions">
            ...
            <a href="{{ route('messages.index') }}" class="nav-icon-btn" title="Pesan">
        ...
        <aside class="sidebar">
            <div class="sidebar-section">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <a href="{{ url('/skill-exchange') }}" class="{{ request()->is('skill-exchange*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ url('/peluang/beasiswa') }}" class="{{ request()->is('peluang/beasiswa') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ url('/peluang/kompetisi') }}" class="{{ request()->is('peluang/kompetisi') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ url('/peluang/seminar-webinar') }}" class="{{ request()->is('peluang/seminar-webinar') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('study-club.index') }}" class="menu-item">
